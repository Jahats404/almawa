            ...
            <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="h5 mb-0 font-weight-bold text-danger">DATA ANDA BELUM LENGKAP!!</div>
                            <div class="h5 mb-0 font-weight-bold text-danger">LENGKAPI DATA DIRI ANDA DENGAN MENGEKLIL TOMBOL DI SEBELAH KANAN!</div>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('agen.lengkapi.data') }}">
        ...
        <div class="col-xl-12 col-md-12 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="h5 mb-0 font-weight-bold text-gray-700">AKUN ANDA SUDAH DIVERIFIKASI</div>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('agen.detail') }}">
                                <i class="fas fa-solid fa-check-circle fa-2x"></i>
                            </a>
                        </div>
                    </div>
                </div>
