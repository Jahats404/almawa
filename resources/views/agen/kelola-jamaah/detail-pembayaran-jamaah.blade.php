...
@section('content')
    <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-4">
        ...
        <!-- Tombol -->
        <a href="{{ route('agen.detail.jamaah', ['id' => $idJamaah]) }}" class="btn btn-sm btn-primary shadow-sm">
    ...
    <div class="row">
        <div class="col-xl-12 col-md-6 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('agen.store.pembayaran.jamaah') }}" method="POST" enctype="multipart/form-data">
                        @csrf
