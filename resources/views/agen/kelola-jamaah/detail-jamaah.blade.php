...
@section('content')
    ...
    <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-4">
        ...
        <!-- Tombol -->
        <a href="{{ route('agen.kelola.jamaah') }}" class="btn btn-sm btn-primary shadow-sm">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="card-header py-3 d-flex flex-wrap align-items-center">
                        ...
                        <a href="{{ route('agen.pembayaran.jamaah', ['id' => $jamaah->pembayaran_jamaah->id_pembayaran]) }}" class="btn btn-sm btn-primary shadow-sm mt-2 mt-md-0">
                            <i class="fas fa-solid fa-dollar-sign fa-sm text-white-50"></i> Detail Pembayaran
                        </a>
                        @endif
                    </div>
                </div>
                ...
                <div class="card-body"> 
                    ...
                    @else
                        <p class="text-center text-danger">Belum melakukan pembayaran.</p>
