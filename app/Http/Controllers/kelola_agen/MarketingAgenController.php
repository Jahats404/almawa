...
class MarketingAgenController extends Controller
{
    public function agen()
    {
        $agen = User::where('role_id', 5)->with('agen')->get();
    
        return view('marketing.kelola-agen.kelola-agen', compact('agen'));
    }
    ...
    public function detail_agen($id)
    {
        ...
        if (Auth()->user()->role->id_role == 1) {
            return view('marketing.kelola-agen.detail-agen', compact('agen'));
        } elseif (Auth()) {
            # code...
        }
    }
    ...
    public function status_agen()
    {
        ...
        return view('marketing.kelola-agen.pengajuan-agen', compact('role', 'agen'));
    }
